...
public class NCGenesBaselineMemMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(NCGenesBaselineMemMessageListener.class);

    public NCGenesBaselineMemMessageListener() {
        super();
    }
