...
@Command(scope = "ncgenes-baselinemem", name = "run-workflow", description = "Run NCGenes Workflow")
@Service
public class RunWorkflowAction implements Action {
    ...
    public Object execute() throws Exception {
        ...
        try {
            ...
            Destination destination = session.createQueue("queue/ncgenes.baseline");
